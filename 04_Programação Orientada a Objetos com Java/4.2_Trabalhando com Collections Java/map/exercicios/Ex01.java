...
public class Ex01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(">>> Exiba a população do estado PE: " + populacoesEstados.get("PE"));

        System.out.println(">>> Exiba todos os estados e suas populaçãos na ordem em que foram informados: ");
        Map<String, Integer> populacoesEstados1 = new LinkedHashMap<>() {{
            put("PE", 9616621);
            put("AL", 3351543);
            put("CE", 9187103);
            put("RN", 3534265);
        }};
        System.out.println(populacoesEstados1);

        System.out.println(">>> Exiba todos os estados e suas populações na ordem alfabética: ");
        Map<String, Integer> populacoesEstados2 = new TreeMap<>(populacoesEstados);
        ...
        System.out.println(">>> Exiba a média da população deste dicionário de estados: " + (soma / populacoesEstados.size()));

        System.out.println(">>> Remova os estados com a população menor que 4.000.000: ");
        Iterator<Integer> iterator1 = populacoesEstados.values().iterator();
